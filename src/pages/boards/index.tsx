    ...
    <>
      ...
      <PageHead  >
        <div className={classNames(styles.pageHead, { [styles.pageHead_M]: isMobile })}>
          <Typography className='pageHeading1' variant='h1'>Explore the national</Typography>
          <Typography variant='h2' className='pageHeading2'>And state boards in India</Typography>
        </div>
      </PageHead>
